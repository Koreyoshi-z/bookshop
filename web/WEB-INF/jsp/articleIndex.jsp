    ...
    <div class="row row-offcanvas row-offcanvas-right">
                ...
                <c:forEach items="${articleTypes}" var="articleType">
                    ...
                    <c:choose>
                        <c:when test="${firstCode eq articleType.code}">
                            <a href="${pageContext.request.contextPath}/article/index?typeCode=${articleType.code}"
        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <div class="alert alert-info" role="alert">
                ...
                <div>
                    <form action="${pageContext.request.contextPath}/article/index"
                          method="get">
                    ...
                    <div class="col-xs-6 col-lg-4">
							<span class="thumbnail">
                                <a href="${pageContext.request.contextPath}/article/detail?id=${article.id}">
									<img src="${pageContext.request.contextPath}/image/article/${article.image}"
                                         style="width: 200px; height: 200px" alt="...">
									<p style="height: 20px; overflow: hidden;">${article.title}${article.description}</p>
							    </a>
								<p><span class="price">${article.price}</span>&nbsp;
            ...
            <ul class="pagination">
                ...
                <c:if test="${pageInfo.hasPreviousPage }">
                    <li><a href="index?pn=${pageInfo.pageNum-1 }" aria-label="Previous"> <span
                ...
                <c:if test="${pageInfo.hasNextPage }">
                    <li><a href="index?pn=${pageInfo.pageNum+1 }" aria-label="Next"> <span
