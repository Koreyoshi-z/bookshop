...
<nav class="navbar navbar-fixed-top navbar-inverse" role="navigation">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="<c:url value="/article_manager/getAll"/>">电商系统,卖家系统-商品管理</a>
        </div>
        
         <div id="navbar" class="collapse navbar-collapse">
        	<ul class="nav navbar-nav">
        	   <li><a href="<c:url value="/article_manager/getAll"/>">商品管理</a></li>
	           <li><a href="<c:url value="/articleType_manager/getAll"/>">商品类型管理</a></li>
	           <li><a href="<c:url value="/order_manager/getAll"/>">订单管理</a></li>
          	</ul>
	...
	<div class="container">
		<div class="row info-content">
			<form id="registerForm" class="form-horizontal" method="post"
				action="${pageContext.request.contextPath}/user_manager/userRegister" style="margin-top: 20px;">
				<div class="form-group">
					<label class="col-sm-2 control-label">登录名称</label>
					<div class="col-sm-3">
						<input type="text" value="" id="loginName" name="loginName" onblur="validName(this)"
