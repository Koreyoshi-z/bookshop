    ...
    <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
            <div class="list-group">
                <c:forEach items="${requestScope.firstArticleTypes }" var="type">
                    <a href="<c:url value="/article_manager/getAll?typeCode=${type.code }"/>" class="list-group-item <c:if test="${type.code eq param.typeCode or top.code eq fn:substring(param.typeCode, 0, 4) }">active</c:if>">${type.name }</a>
                </c:forEach>
            </div>
        </div>
        <!--  侧边导航结束 -->
        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <div class="alert alert-info" role="alert">
                <div>
                    <form action="<c:url value="/article_manager/getAll"/>" method="post">
            ...
            <div class="row">
            	...
            	<span class="thumbnail">
                    <a class="label label-danger" href="<c:url value="/article_manager/removeArticle?id=${a.id}"/>">下架</a>
                    <a class="label label-success" href="<c:url value="/article_manager/showUpdate?id=${a.id }"/>">修改</a>
				    <a href="<c:url value="/article_manager/preArticle?id=${a.id }"/>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body ">
                <div align="center">
                    ...
                    <form name="articleform" class="form-horizontal" action="<c:url value="/article_manager/addArticle"/>" enctype="multipart/form-data" method="post">
