...
function minuFun(articleId){
	   ...
	   if(num>1){
		   ...
		   //发送请求更新购物车中购买的数量 
		   window.location = "${pageContext.request.contextPath}/shopcart/updateShopcart?id="+articleId+"&number="+obj.value;
...
<body>
	...
	<div class="container">
			...
			<div class="col-xs-12 col-sm-12">
				...
				<div class="table-responsive">
					<table class="table table-hover table-bordered table-striped">
						...
						<c:forEach items="${shopcarts}" var="shopCar">
						     <tr>
								...
								<td><a href="${pageContext.request.contextPath}/shopcart/deleteShopcart?id=${shopCar.article.id}">删除</a>
									<a>收藏</a></td>
							</tr>
						</c:forEach>
		...
		<!--/row-->
        <form action="${pageContext.request.contextPath}/order/orderSubmit" method="post" id="form">
